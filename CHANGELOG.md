...
- Rust [`naming`](https://docs.rs/tauri-plugin-keyring/latest/tauri_plugin_keyring/naming/index.html) helpers (`join_prefix`, `split_prefixed`) and guest-js `joinKeyPrefix` / `splitKeyPrefix`.
